...
public class OrbotHelper implements ProxyHelper {
    ...
    private final static String WAKE_UP_ACTIVITY = ".WakeUpActivity";

    public final static String ORBOT_PACKAGE_NAME = "org.torproject.android";
    public final static String ORBOT_WAKE_UP_ACTIVITY = ORBOT_PACKAGE_NAME + WAKE_UP_ACTIVITY;
    ...
    public final static String TOR_SERVICES_WAKE_UP_ACTIVITY = TOR_SERVICES_PACKAGE_NAME + WAKE_UP_ACTIVITY;
    public final static String TOR_SERVICES_MARKET_URI = "market://details?id=" + TOR_SERVICES_PACKAGE_NAME;
    public final static String TOR_SERVICES_FDROID_URI = "https://f-droid.org/repository/browse/?fdid="
            + TOR_SERVICES_PACKAGE_NAME;
    public final static String TOR_SERVICES_PLAY_URI = "https://play.google.com/store/apps/details?id="
            + TOR_SERVICES_PACKAGE_NAME;
...
*/
     ...
     * <p>
     * This {@code Intent} will only start Orbot, not TorServices.
     *
     * @see #getTorStartIntent(Context)
     */
    ...
    public boolean isInstalled(Context context) {
        return isOrbotInstalled(context) || isTorServicesInstalled(context);
    }
    ...
    public Intent getStartIntent(Context context) {
        return OrbotHelper.getTorStartIntent(context);
    }
     ...
     * {@link Application} subclass, in its
